...
def test_base_criteria_validation_skill_level():
    ...
    with pytest.raises(
        ValueError, match="player_skill_level must be between 0 and 100"
    ):
...
def test_base_criteria_validation_team_offense():
    ...
    with pytest.raises(
        ValueError, match="team_offense_level must be between 0 and 100"
    ):
...
def test_base_criteria_validation_opponent_defense():
    ...
    with pytest.raises(
        ValueError, match="opponent_defense_level must be between 0 and 100"
    ):
...
def test_base_criteria_validation_touch_percentage():
    ...
    with pytest.raises(
        ValueError, match="positional_touch_percentage must be between 0 and 100"
    ):
...
def test_base_criteria_validation_trend_score():
    ...
    with pytest.raises(
        ValueError, match="recent_trend_score must be between -100 and 100"
    ):
...
def test_yearly_criteria_validation_age_deviation():
    ...
    with pytest.raises(
        ValueError, match="age_deviation_from_optimum must be between -10 and 10"
    ):
...
def test_yearly_criteria_validation_coaching_stability():
    ...
    with pytest.raises(
        ValueError, match="coaching_stability_score must be between 0 and 100"
    ):
...
def test_weekly_criteria_validation_defense_rank():
    ...
    with pytest.raises(
        ValueError, match="opposing_defense_vs_position_rank must be between 1 and 32"
    ):
...
def test_weekly_criteria_validation_momentum():
    ...
    with pytest.raises(
        ValueError, match="offensive_momentum_score must be between -100 and 100"
    ):
...
def test_weekly_criteria_validation_weather():
    ...
    with pytest.raises(
        ValueError, match="weather_impact_score must be between -100 and 100"
    ):
